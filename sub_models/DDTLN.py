...
class DDTLN(nn.Module):
    def __init__(self, pretrained=False, in_channel=1, out_channel=5):
        ...
        self.feature_layers = nn.Sequential(
            ...
            nn.Conv1d(1, 32, kernel_size=64, stride=16,padding=1,dilation=1),  # 16, 26 ,26  ###105###   nn.Conv1d(1, 16, kernel_size=81, stride=8,padding=1,dilation=1), 
            nn.BatchNorm1d(32),
            ...
            nn.Conv1d(128, 256, kernel_size=3, stride=1,padding=1),  # 32, 24, 24
            nn.BatchNorm1d(256),
            nn.ReLU(inplace=True),
            # nn.Dropout(0.5),
            nn.MaxPool1d(kernel_size=2, stride=2),
            
            nn.Conv1d(256, 512, kernel_size=3, stride=1,padding=1),  # 32, 24, 24
            nn.BatchNorm1d(512),
            # nn.RReLU(0.0,0.5),
            nn.ReLU(inplace=True),
        ...
        self.__in_features = 512   #576    256
